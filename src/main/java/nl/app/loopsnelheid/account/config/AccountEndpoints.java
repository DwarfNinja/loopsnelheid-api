...
public class AccountEndpoints {
    ...
    public static final String VERIFY_DIGITAL_CODE_PATH = "/verify/code/{userId}/{digitalCode}";
    public static final String VERIFY_TOKEN_PATH = "/verify/token/{userId}/{token}";
