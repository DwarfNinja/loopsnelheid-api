...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http = http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, AccountEndpoints.REGISTER_PATH + AccountEndpoints.VERIFY_TOKEN_PATH).permitAll()
                .antMatchers(HttpMethod.POST, AccountEndpoints.REGISTER_PATH + AccountEndpoints.VERIFY_DIGITAL_CODE_PATH).permitAll()
